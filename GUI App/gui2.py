...
#         self.category_menu["values"] = ["Housing", "Food", "Transportation", "Entertainment", "Miscellaneous"]
...
#         self.view_button = tk.Button(self.button_frame, text="View Expenditure Chart", command=self.view_expenditure_chart)
#         self.view_button.pack(side=tk.LEFT)

#     def add_expenditure(self):
#         amount = float(self.amount_entry.get())
#         category = self.category_var.get()
#         if category in self.expenditure_data:
#             self.expenditure_data[category] += amount
#         else:
#             self.expenditure_data[category] = amount
#         self.amount_entry.delete(0, tk.END)

#     def view_expenditure_chart(self):
#         categories = list(self.expenditure_data.keys())
#         amounts = list(self.expenditure_data.values())
#         plt.pie(amounts, labels=categories, autopct="%1.1f%%")
#         plt.title("Expenditure Chart")
#         plt.show()
